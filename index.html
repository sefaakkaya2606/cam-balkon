...
<body>
  <main class="container">
    ...
    <section class="card">
      ...
      <button id="hesaplaBtn" class="btn primary" type="button">Hesapla</button>
    ...
    <section class="card">
      ...
      <div id="admin-login-box">
        ...
        <button id="btnAdminLogin" class="btn" type="button">Giriş Yap</button>
        <p class="muted">
      ...
      <div id="admin-panel" class="hidden">
        <div class="toolbar">
          ...
          <button id="btnLogout" class="btn outline" type="button">Çıkış</button>
        </div>
        ...
        <button id="btnSavePrices" class="btn" type="button">Kaydet</button>
        ...
        <div class="grid3">
          <div>
            ...
            <button id="btnChangePin" class="btn small" type="button">PIN’i Güncelle</button>
          </div>
          <div>
          ...
          <div>
            ...
            <button id="btnAddAdmin" class="btn small" type="button">Yönetici Ekle</button>
          </div>
        </div>
      </div>
    </section>
